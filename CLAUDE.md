...
```bash
bd create "Short title" --description="Detailed context" -t bug|feature|task -p 0-4 --json
bd create "Short title" --description="What this issue is about" -p 1 --deps discovered-from:bd-123 --json
```
